...
// பின்னணியின் அடர்த்தியை வைத்து ஆட்டோ டெக்ஸ்ட் நிறத்தைக் கணக்கிடும் ஃபங்ஷன்
...
export default function ThemeDisplayTab() {
  ...
  const [themeConfig, setThemeConfig] = useState(() => {
    ...
    return {
      ...
      // Sidebar & Subscribe Dock Bar Settings
  ...
  // Toggle Auto Text Color with Tick Mark
  ...
  // Toggle Auto Sidebar Text with Tick Mark
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">
              10-வண்ண ஸ்வாட்ச்கள், மேனுவல்/தானியங்கி எழுத்து கான்ட்ராஸ்ட், அக்ரிலிக் அலைகள் மற்றும் சைட்பார் வண்ணங்கள்.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-5 rounded-2xl win11-card border border-white/[0.08] space-y-4">
        <div className="flex items-center justify-between border-b border-white/5 pb-3">
          <div>
            ...
            <p className="text-[10px] text-slate-400">10 கலர் ஸ்வாட்ச்கள் அல்லது மேனுவல் பிக்கர். டிக் மார்க் இருந்தால் எழுத்து நிறம் தானாக மாறும்.</p>
          </div>
        ...
        <div className="flex items-center justify-between border-b border-white/5 pb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400">சைட்பார் பின்னணி மற்றும் பட்டன் லேபிள்களின் நிறங்கள்.</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-4 rounded-xl bg-black/30 border border-white/5 space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-[11px] text-slate-400">கார்டுகளின் விளிம்பில் ஒளிரும் பார்டர் நிறம்</span>
            </div>
          </div>
